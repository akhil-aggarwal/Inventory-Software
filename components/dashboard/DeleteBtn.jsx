...
{   
            ...
            if (result.isConfirmed) {
                ...
                if(res.ok)
                    {   
                        ...
                        Swal.fire({
                            title: "Deleted!",
                            text: "Resource Deleted Sucessfully",
                            icon: "success"
                        });
                    }
    ...
    return(
        ...
        {loading ? (
            ...
            text-[0.5rem] px-5 py-2.5 text-center mr-2 dark:bg-red-600 dark:hover:bg-red-700 
            ...
            <button onClick={handleDelete} className="font-medium text-red-600 dark:text-red-500 
