...
import { History, Plus, Users2, Bell, Settings, ChevronDown, LayoutGrid, List, MoreHorizontal, HelpCircle } from "lucide-react";
    ...
    return(
        <div className="flex justify-between items-center bg-white py-5 px-4">
            ...
            <div className="flex gap-4">
                {/* New */}
                <Link href={newLink} className="p-1 rounded-sm bg-blue-600 px-3
